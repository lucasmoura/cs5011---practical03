...
public class MapTest 
{
	...
	{
		ArrayList<Cave> tunnels = map.getCave(1);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(2);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(3);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(4);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(5);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(6);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(7);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(8);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(9);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(10);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(11);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(12);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(13);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(14);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(15);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(16);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(17);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(18);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(19);
	...
	{
		ArrayList<Cave> tunnels = map.getCave(20);
